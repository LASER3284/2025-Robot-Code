...
import frc.robot.commands.pivotintake.PivotDeploy;
...
public class RobotContainer {
    ...
    private Angle degrees = Degrees.of(90);
     ...
     //       point.withModuleDirection(new Rotation2d(-joystick.getLeftY(), -joystick.getLeftX()))
      ...
      //  joystick.start().and(joystick.x()).whileTrue(drivetrain.sysIdQuasistatic(Direction.kReverse));
       ...
       // drivetrain.registerTelemetry(logger::telemeterize);
        ...
        joystick.b().onTrue(pivot.stop_Command());
        joystick.a().onTrue(new PivotDeploy(pivot, degrees));

        joystick.x().whileTrue(new PivotDeploy(pivot, degrees));
    }
